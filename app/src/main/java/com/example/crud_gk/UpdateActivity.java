...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateID, updateName, updateBrand, updatePrice, updateDesc;
    //String id, name, brand, price, desc;
    String imageURL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Android CRUD").child(key);
    ...
    public void saveData (){
        storageReference = FirebaseStorage.getInstance().getReference().child("Image Folder").child(uri.getLastPathSegment());
